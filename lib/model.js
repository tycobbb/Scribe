...
//  
// @param collectionName: The name of the related collection (expected to be plural)
// @param helpers: Object specifyying relationship-type-specific helper functionality 
//
Model.relationship = function(collectionName, helpers) {
  var self = this;
  ...
  self[helpers.find.name] = function(query) {
    ...
    return relationship.findOne.apply(arguments); 
  };
...
Model.toOne = function(collectionName) {
  ...
  helpers.find = {
    ...
    name: collectionName.singularize(),
    ...
    query: function(model, query) {
      ...
      query._id = this[foreignKey];
    }
  };

  return this.relationship(collectionName, helpers);
};
